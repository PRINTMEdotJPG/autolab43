    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('started', 'Начат'), ('in_progress', 'В процессе'), ('completed', 'Завершен'), ('failed', 'Ошибка')], default='started', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gamma_calculated', models.FloatField(default=0, verbose_name='Рассчитанное γ')),
                ...
                ('error_percent', models.FloatField(blank=True, null=True, verbose_name='Отклонение (%)')),
                ('status', models.CharField(choices=[('success', 'Успешно'), ('fail', 'Неудача'), ('pending', 'Ожидает проверки')], default='pending', max_length=10)),
