    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_error', models.FloatField(blank=True, null=True, verbose_name='Студенческое отклонение')),
                ('status', models.CharField(choices=[('success', 'Успешно'), ('fail', 'Неудача'), ('pending', 'Ожидает проверки')], default='pending', max_length=10, verbose_name='Статус')),
                ('visualization_data', models.JSONField(blank=True, null=True, verbose_name='Данные для визуализации')),
