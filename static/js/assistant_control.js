...
window.app = {
    ...
    config: { // Конфигурация приложения
        ARDUINO_TUBE_POSITION_CALIBRATION_MM: 40 // Калибровочное смещение для датчика положения трубки в мм. Измените это значение для калибровки.
    }
};
...
// Калибровочное смещение для датчика положения трубки в мм. Измените это значение для калибровки. УДАЛЯЕМ ЭТО